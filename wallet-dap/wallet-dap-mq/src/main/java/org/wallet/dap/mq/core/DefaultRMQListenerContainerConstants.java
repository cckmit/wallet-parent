 ...
 */
public class DefaultRMQListenerContainerConstants {
    ...
    public static final String PROP_ROCKET_MQ_LISTENER = "rocketMQListener";
    public static final String PROP_OBJECT_MAPPER = "objectMapper";
    public static final String PROP_CONSUME_MESSAGE_BATCH_MAXSIZE = "consumeMessageBatchMaxSize";
    public static final String PROP_MAX_RE_CONSUME_TIMES = "maxReconsumeTimes";
