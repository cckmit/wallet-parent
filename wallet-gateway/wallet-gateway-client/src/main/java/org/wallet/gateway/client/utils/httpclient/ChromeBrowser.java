 ...
 * @author zengfucheng
 **/
public class ChromeBrowser extends HttpBeforePoint implements Browser{
    private static final String NAME = "Chrome";
    private static final String OS = "Windows NT 10.0; Win64; x64";
    private static final String VERSION = "70.0.3538.67";
    private String os;
    ...
    public ChromeBrowser(String os, String version) {
        this.os = os;
